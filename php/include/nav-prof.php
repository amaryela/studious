<header class="header sticky-top" id="navhead">
  <nav class="navbar sticky-top navbar-expand-lg navbar-light scrolling-navbar">
    ...
    <div class="d-flex align-items-center">
      <a class="text-reset me-3" href="profHome.php" style=" margin:5px;">
        ...
        <?php
          $today = date("Y-m-d");
          $join = mysqli_query($conn,"SELECT room.*, scheduledquizzes.* FROM room JOIN scheduledquizzes ON room.roomCode=scheduledquizzes.quiz_roomcode WHERE room.owner='$userid' AND scheduledquizzes.quiz_date='$today' AND scheduledquizzes.status !='finished' AND room.status = 'on'");
